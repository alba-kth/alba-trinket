...
2. Open an exercise in your browser:
   ```
   http://localhost:8000/out/trinket1.html
   ```
...
```
python3 generate.py src/kapitel_1/trinket1.md   # single file
...
```
python3 generate.py src/kapitel_1/ --out ~/public_html/alba-trinket/ --asset-prefix ""
```

## Screenshots

`rgtutor1.jpg`, `rgtutor2.jpg`, `rgtutor4.jpg` — each shows the browser rendering
(right) alongside the markdown source with syntax highlighting (left), with arrows explaining:
